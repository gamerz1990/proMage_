...
describe("ProjectController", () => {
    ...
    it("should return a list of tasks", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const findStub = sinon_1.default.stub(taskModel.default, "find").returns({
            limit: sinon_1.default.stub().returnsThis(),
            skip: sinon_1.default.stub().returnsThis(),
            populate: sinon_1.default.stub().returnsThis(),
            exec: sinon_1.default.stub().resolves(expectedTasks),
        });
        sinon_1.default.stub(taskModel.default, "countDocuments").resolves(1);
        let data = yield (0, task_1.listTasks)(mockRequest, mockResponse);
        // Assertions
